...
export default function Home() {
  ...
  // How many dates this search will actually hit — one SerpApi call each.
  const requestedDays = (() => {
  ...
  const searchedDays = Math.min(requestedDays, SEARCH_MAX_DAYS)
  const capped = requestedDays > searchedDays
